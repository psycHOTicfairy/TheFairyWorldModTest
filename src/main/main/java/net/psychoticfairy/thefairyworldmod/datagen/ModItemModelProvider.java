...
public class ModItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
            ...
            trimmedArmorItem(ModItems.PINEAPPLE_SKIN_HELMET);
            trimmedArmorItem(ModItems.PINEAPPLE_SKIN_CHESTPLATE);
            trimmedArmorItem(ModItems.PINEAPPLE_SKIN_LEGGINGS);
            trimmedArmorItem(ModItems.PINEAPPLE_SKIN_BOOTS);


    }
    private void trimmedArmorItem(RegistryObject<Item> itemRegistryObject) {
        final String MOD_ID = TheFairyWorldMod.MOD_ID; // Change this to your mod id
